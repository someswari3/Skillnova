...
const Login = () => {
  ...
  const goToSignup = useAuthStore((s) => s.goToSignup);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormError(getErrorMessage(err) || "Login failed. Please try again.");
    }
  };
  ...
  return (
    <div className="auth-container">
      <a href="#main-form" className="auth-skip-link">
        Skip to form
      </a>
      ...
      <div className="auth-card" role="main" aria-label="Sign in to SkillNova">
        ...
        >
          <div
            className={`auth-form-group ${emailState === "error" ? "is-error" : emailState === "success" ? "is-success" : ""}`}
          >
            ...
            {emailState === "error" && (
              <p
                ...
                role="alert"
              >
                <Icon.Alert /> {fieldError.email}
              </p>
            )}
            {emailState === "success" && (
              <p className="auth-msg auth-msg-success">
                <Icon.Check /> Email looks good.
              </p>
            )}
          </div>
